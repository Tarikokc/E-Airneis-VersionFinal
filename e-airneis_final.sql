...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 31 juil. 2024 à 22:05
...
INSERT INTO `panier` (`id`, `user_id`, `product_id`, `quantite`, `prix`) VALUES
(39, 65, 12, 1, 45),
(40, 66, 18, 1, 54);
...
(15, 13, 'hamac.jpg', 1),
(17, 14, 'tapis.jpg', 1),
(18, 15, 'bureau-cream.jpg', 1),
(19, 21, 'fauteuil-zen.jpg', 1),
(20, 16, 'mini-vases-leopard.jpg', 1),
(21, 17, 'plateau-bois-wavy.jpg', 1),
(22, 19, 'pot-crayon-bear.jpg', 1),
(23, 18, 'porte-poster-wavy.jpg', 1),
(24, 20, 'tableau-lin.jpg', 1);
...
(15, 'Bureau Cream', 'Bureau en MDF avec placage en frêne verni. Modèle à angles arrondis avec ouverture au moyen de panneaux à jalousie en pin pouvant coulisser sur le pourtour. Étagère avec séparateur au centre. Pieds en métal verni. Article facile à assembler, visserie incluse.\r\nDesigner : Ronan et Erwan Bouroulllec', 1250.00, 6, 1, 5),
(16, 'Mini vases Léopard (lot de 2)', 'Ensemble de deux petits vases en verre soufflé artisanal à motif. Diamètre des ouvertures 2 cm. Diamètres 6 cm environ. Hauteurs 6,5 cm et 9,5 cm.\r\n\r\nDesigner : Arne Jacobsen', 59.00, 34, 3, 2),
(17, 'Plateau en bois wavy', 'Plateau en bois avec bord ondulé à la base. Une pièce décorative au design plein de charme, destinée à ranger des bijoux ou d\'autres petits objets. Hauteur 5 cm. Largeur 27x27 cm.\r\nDesigner : Verner Panton', 79.99, 50, 3, 9),
(18, 'Porte poster wavy', 'Porte-poster à bords ondulés de la collection WAVY. Modèle constitué de deux parties munies d\'aimants dissimulés qui permettent également de maintenir le poster en place. Cordon de suspension sur un montant. \r\nDesigner : Verner Panton', 54.99, 50, 3, 9),
(19, 'Pot à crayon bear', 'Pot à crayons en contreplaqué avec oreilles en haut, pour un bureau d\'enfant inspiré par la tendance Scandinave. Dimensions 8x8x9 cm.\r\n\r\nDesigner : Jasper Morrison', 19.00, 50, 1, 6),
(20, 'Tableau Sand', 'Décoration murale imprimée sur une toile de lin mélangé avec cadre en bois solide et dos en MDF. Ses tons neutres et naturels s\'accordent avec tous les styles de déco intérieure et rappellent le sable. Fixations sur l\'arrière permettant de l\'accrocher dans un sens ou dans l\'autre. \r\nDesigner : Patricia Urquiola', 109.99, 20, 3, 4),
(21, 'Fauteil Zen', 'Zen, un beau fauteuil élancé qui s\'intègre parfaitement à tout style d\'intérieur. Le tissu est composé de 100% de polyester et a un Martindale de 20.000. La construction de Zen est faite de contreplaqué. Le siège contient une couche de mousse normale de 24kg/m3.\r\nDesigner : Jean Prouvé', 729.99, 12, 2, 7);
...
(65, 'hailelsavadoux@gmail.com', '$2y$13$UQkXql1xZJCg5vFF9v.jWedSM.chbjmYerMhuMS6k8qKg07j.4aDG', 'Hailé', 'Savadoux', NULL, NULL, NULL, NULL, NULL, 1, '84ceac0b81d05cfe66f9ee955367e7a42cf9c94138c7ba041682e80d73a4', NULL),
(66, 'hailelsavadoux1@gmail.com', '$2y$13$CUoq9siFWw.0X4eV0fMx5.Kwsxsq4R4Pok879/BEUzAdX.OUl26g2', 'Hai', 'lé', NULL, NULL, NULL, NULL, NULL, 1, 'cacbbdde572d65eae61aea75003f081604e563eb47bc34aed5081ff1c599', NULL),
(67, 'jean@gmail.com', '$2y$13$wLWpo.n7iVf19UJqqsy2Xu99O898LZQdKtxnjNcntCk3SpC7eWfJO', 'jean', 'jean', NULL, NULL, NULL, NULL, NULL, 1, '656efbda0411609e94ee4690fb568596176f2184d6eb4ce678244821c116', NULL);
